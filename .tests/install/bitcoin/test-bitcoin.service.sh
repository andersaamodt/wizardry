...
_run_test_case "install/bitcoin/bitcoin.service declares an Install section" has_install_section
shows_help() {
  _run_spell spells/install/bitcoin/bitcoin.service --help
  # Note: spell may not have --help implemented yet
  true
}

_run_test_case "bitcoin.service shows help" shows_help
_finish_tests
