...
manage_system_rejects_missing_arguments() {
  ...
  _run_cmd "$ROOT_DIR/spells/install/core/manage-system-command"
  _assert_failure || return 1
...
manage_system_rejects_single_argument() {
  ...
  _run_cmd "$ROOT_DIR/spells/install/core/manage-system-command" some-command
  _assert_failure || return 1
  _assert_error_contains "Usage: manage-system-command" || return 1
}
...
shows_help() {
  _run_spell spells/install/core/manage-system-command --help
  true
}
