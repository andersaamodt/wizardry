...
STUB
  ...
  # With new xattr architecture, getfattr alone is enough to list attributes
  # but we still need a writer (attr/xattr/setfattr) to clear them
  # Without a writer, it should fail
