...
STUB
  ...
  : >"$tmpfile"
  PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$stub_dir:/bin:/usr/bin" _run_spell "spells/enchant/disenchant" "$tmpfile"
...
STUB
  ...
  PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$stub_dir:/bin:/usr/bin" _run_spell "spells/enchant/disenchant" "$target" user.note
...
STUB
  ...
  PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$stub_dir:/bin:/usr/bin" _run_spell "spells/enchant/disenchant" "$target"
  _assert_success
  called=$(cat "$WIZARDRY_TMPDIR/disenchant.call")
...
STUB
  ...
  : >"$target"
  PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$stub_dir:/usr/bin:/bin" _run_spell "spells/enchant/disenchant" "$target"
