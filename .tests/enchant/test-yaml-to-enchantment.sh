...
yaml_to_enchantment_help_via_sourcing() {
  _run_sourced_spell yaml-to-enchantment --help
...
_run_test_case "yaml-to-enchantment works via source-then-invoke" yaml_to_enchantment_help_via_sourcing
_finish_tests
