...
_run_test_case "pkg-has without package fails" test_pkg_has_no_package_fails
_run_test_case "pkg-has with empty package fails" test_pkg_has_empty_package_fails
