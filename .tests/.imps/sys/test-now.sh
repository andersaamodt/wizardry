...
test_now_outputs_timestamp() {
  _run_spell spells/.imps/sys/now
  _assert_success
...
_run_test_case "now outputs timestamp" test_now_outputs_timestamp
_run_test_case "now returns positive value" test_now_returns_positive_value
