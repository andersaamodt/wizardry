...
test_disable_palette_clears_colors() {
  ...
  run_cmd sh -c ". '$ROOT_DIR/spells/cantrips/colors'; . '$ROOT_DIR/spells/.imps/out/disable-palette'; disable_palette; printf '%s' \"\$RESET\""
  assert_success
...
test_disable_palette_clears_theme_colors() {
  run_cmd sh -c ". '$ROOT_DIR/spells/cantrips/colors'; . '$ROOT_DIR/spells/.imps/out/disable-palette'; disable_palette; printf '%s' \"\$THEME_HIGHLIGHT\""
  assert_success
...
test_disable_palette_clears_mud_colors() {
  run_cmd sh -c ". '$ROOT_DIR/spells/cantrips/colors'; . '$ROOT_DIR/spells/.imps/out/disable-palette'; disable_palette; printf '%s' \"\$MUD_LOCATION\""
  assert_success
...
test_disable_palette_sets_flag() {
  ...
  run_cmd sh -c ". '$ROOT_DIR/spells/cantrips/colors'; . '$ROOT_DIR/spells/.imps/out/disable-palette'; disable_palette; printf '%s' \"\$WIZARDRY_COLORS_AVAILABLE\""
  assert_success
...
test_disable_palette_multiple_colors_empty() {
  ...
  run_cmd sh -c ". '$ROOT_DIR/spells/cantrips/colors'; . '$ROOT_DIR/spells/.imps/out/disable-palette'; disable_palette; printf '%s|%s|%s|%s' \"\$RED\" \"\$GREEN\" \"\$BLUE\" \"\$CYAN\""
  assert_success
