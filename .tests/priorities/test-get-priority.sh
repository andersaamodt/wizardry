...
get_priority_help_via_sourcing() {
  _run_sourced_spell get-priority --help
  _assert_success || return 1
...
_run_test_case "get-priority works via source-then-invoke" get_priority_help_via_sourcing
_finish_tests
