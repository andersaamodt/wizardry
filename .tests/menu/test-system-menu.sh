...
SH
  ...
  args=$(cat "$tmp/log")
  case "$args" in
    *"System Menu:"*"Restart...%shutdown-menu"*"Update all software%update-all -v"*"Update wizardry%update-wizardry"*"Manage services%"*"services-menu"*"Test all wizardry spells%$ROOT_DIR/spells/system/test-magic"*"Exit%exit-menu"* ) : ;;
