...
profile_tests_help_via_sourcing() {
  _run_sourced_spell profile-tests --help
  _assert_success || return 1
...
_run_test_case "profile-tests works via source-then-invoke" profile_tests_help_via_sourcing
_finish_tests
