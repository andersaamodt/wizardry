...
test_profiles_single_test() {
  ...
  assert_output_contains "test-has.sh" || return 1
}
...
run_test_case "profile-tests prints usage" test_help
run_test_case "profile-tests profiles single test" test_profiles_single_test
run_test_case "profile-tests writes output to file" test_output_to_file
run_test_case "profile-tests shows time distribution" test_shows_time_distribution
run_test_case "profile-tests shows slowest tests" test_shows_slowest_tests
run_test_case "profile-tests handles no pattern match" test_handles_no_pattern_match
