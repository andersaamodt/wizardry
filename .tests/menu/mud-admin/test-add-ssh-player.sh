...
add_ssh_player_help_via_sourcing() {
  _run_sourced_spell add-ssh-player --help
  _assert_success || return 1
...
_run_test_case "add-ssh-player works via source-then-invoke" add_ssh_player_help_via_sourcing
_finish_tests
