...
services_menu_help_via_sourcing() {
  _run_sourced_spell services-menu --help
...
_run_test_case "services-menu works via source-then-invoke" services_menu_help_via_sourcing
_finish_tests
