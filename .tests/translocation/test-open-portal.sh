...
test_requires_sshfs() {
  ...
  PATH="$ROOT_DIR/spells/.imps:$stubdir" run_spell "spells/translocation/open-portal"
...
EOF
  ...
  MUD_PLAYER="" PATH="$ROOT_DIR/spells/.imps:$stubdir" run_spell "spells/translocation/open-portal"
  assert_failure || return 1
