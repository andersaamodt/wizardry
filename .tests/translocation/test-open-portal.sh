...
test_requires_sshfs() {
  ...
  PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$ROOT_DIR/spells/cantrips:$stubdir" _run_spell "spells/translocation/open-portal"
...
EOF
  ...
  MUD_PLAYER="" PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$ROOT_DIR/spells/cantrips:$stubdir" _run_spell "spells/translocation/open-portal"
  _assert_failure || return 1
