...
test_missing_enchant() {
  ...
  stub=$(make_stub_dir)
  PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/sys:$stub:$WIZARDRY_TEST_MINIMAL_PATH" _run_spell "spells/mud/decorate"
...
EOF
  ...
  PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/sys:$stub:$WIZARDRY_TEST_MINIMAL_PATH" _run_spell "spells/mud/decorate" "/nonexistent/path" "description"
...
EOF
  chmod +x "$stub/enchant"
  PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/sys:$stub:$WIZARDRY_TEST_MINIMAL_PATH" _run_spell "spells/mud/decorate" "$target" ""
...
EOF
  chmod +x "$stub/enchant"
  PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/sys:$stub:$WIZARDRY_TEST_MINIMAL_PATH" _run_spell "spells/mud/decorate" "$target" "A mystical chamber"
...
EOF
  ...
  PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/sys:$stub:$WIZARDRY_TEST_MINIMAL_PATH" _run_spell "spells/mud/decorate" "A secret alcove" "$target"
  _assert_success && _assert_output_contains "decorated with the description"
  called=$(cat "$WIZARDRY_TMPDIR/decorate.called")
  # Check that enchant was called with correct arguments
  case "$called" in
...
EOF
  ...
  RUN_CMD_WORKDIR="$target" PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/sys:$stub:$WIZARDRY_TEST_MINIMAL_PATH" _run_spell "spells/mud/decorate" "The entrance hall"
  _assert_success
  called=$(cat "$WIZARDRY_TMPDIR/decorate.called")
...
EOF
  chmod +x "$stub/enchant"
  PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/sys:$stub:$WIZARDRY_TEST_MINIMAL_PATH" _run_spell "spells/mud/decorate" "$target" "description"
