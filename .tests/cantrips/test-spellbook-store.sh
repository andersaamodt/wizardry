...
spellbook_store_help_via_sourcing() {
  _run_sourced_spell spellbook-store --help
...
_run_test_case "spellbook-store works via source-then-invoke" spellbook_store_help_via_sourcing
_finish_tests
