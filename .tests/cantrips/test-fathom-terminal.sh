...
fathom_terminal_help_via_sourcing() {
  _run_sourced_spell fathom-terminal --help
...
_run_test_case "fathom-terminal works via source-then-invoke" fathom_terminal_help_via_sourcing
_finish_tests
