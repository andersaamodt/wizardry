...
install_service_template_help_via_sourcing() {
  _run_sourced_spell install-service-template --help
...
_run_test_case "install-service-template works via source-then-invoke" install_service_template_help_via_sourcing
_finish_tests
