...
service_status_help_via_sourcing() {
  _run_sourced_spell service-status --help
  _assert_success || return 1
...
_run_test_case "service-status works via source-then-invoke" service_status_help_via_sourcing
_finish_tests
