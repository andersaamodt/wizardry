...
logging_example_help_via_sourcing() {
  _run_sourced_spell logging-example --help
...
_run_test_case "logging-example works via source-then-invoke" logging_example_help_via_sourcing
_finish_tests
