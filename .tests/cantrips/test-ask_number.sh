...
test_ask_number_rejects_invalid_max() {
  run_cmd "$ROOT_DIR/spells/cantrips/ask_number" "Question" 1 notanint
...
test_ask_number_rejects_min_gt_max() {
  run_cmd "$ROOT_DIR/spells/cantrips/ask_number" "Question" 10 5
