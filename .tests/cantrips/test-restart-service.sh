...
restart_service_help_via_sourcing() {
  _run_sourced_spell restart-service --help
  _assert_success || return 1
...
_run_test_case "restart-service works via source-then-invoke" restart_service_help_via_sourcing
_finish_tests
