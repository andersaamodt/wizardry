...
test_requires_service_name() {
  ...
  PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$stub_dir:/bin:/usr/bin" _run_spell "spells/cantrips/remove-service"
...
test_reports_missing_service() {
  ...
  REMOVE_SERVICE_ASK_TEXT="$stub_dir/ask-text" \
  SYSTEMCTL_STATE_DIR="$stub_dir/state" \
  PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$stub_dir:/bin:/usr/bin" _run_spell "spells/cantrips/remove-service" missing
...
test_stops_and_removes_service() {
  ...
  PATH="$WIZARDRY_CANTRIPS_PATH:$WIZARDRY_IMPS_PATH:$stub_dir:/bin:/usr/bin" _run_spell "spells/cantrips/remove-service" demo
