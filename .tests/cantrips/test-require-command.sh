...
require_command_help_via_sourcing() {
  _run_sourced_spell require-command --help
  _assert_success || return 1
...
_run_test_case "require-command works via source-then-invoke" require_command_help_via_sourcing
_finish_tests
