...
read_contact_help_via_sourcing() {
  _run_sourced_spell read-contact --help
  _assert_success || return 1
...
_run_test_case "read-contact works via source-then-invoke" read_contact_help_via_sourcing
_finish_tests
