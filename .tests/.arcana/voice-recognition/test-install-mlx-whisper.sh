...
test_install_mlx_whisper_help() {
  run_spell "spells/.arcana/voice-recognition/install-mlx-whisper" --help
  assert_success || return 1
  assert_output_contains "Usage: install-mlx-whisper" || return 1
}

test_install_mlx_whisper_rejects_unsupported_host() {
  run_cmd env \
...
test_install_mlx_whisper_installs_on_apple_silicon() {
...
run_test_case "install-mlx-whisper shows help" test_install_mlx_whisper_help
run_test_case "install-mlx-whisper rejects unsupported hosts" test_install_mlx_whisper_rejects_unsupported_host
run_test_case "install-mlx-whisper installs on Apple Silicon" test_install_mlx_whisper_installs_on_apple_silicon
