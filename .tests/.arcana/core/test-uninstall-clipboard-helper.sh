...
test_uninstall_clipboard_helper_is_executable() {
  [ -x "$ROOT_DIR/spells/.arcana/core/uninstall-clipboard-helper" ]
}

test_uninstall_clipboard_helper_has_content() {
  [ -s "$ROOT_DIR/spells/.arcana/core/uninstall-clipboard-helper" ]
}
...
test_uninstall_clipboard_helper_reports_no_helper_when_none_installed() {
  ...
  PATH="$fixture/bin" HOME="$fixture/home" _run_cmd \
    ...
    "$ROOT_DIR/spells/.arcana/core/uninstall-clipboard-helper"
...
shows_help() {
  _run_spell spells/.arcana/core/uninstall-clipboard-helper --help
  true
}
