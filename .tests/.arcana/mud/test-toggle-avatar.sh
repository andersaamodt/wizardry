...
test_help() {
  run_sourced_spell "spells/.arcana/mud/toggle-avatar" --help
...
test_enable_avatar() {
  ...
  # Enable avatar
  run_sourced_spell "spells/.arcana/mud/toggle-avatar" enable
...
test_disable_avatar() {
  ...
  # Disable avatar
  run_sourced_spell "spells/.arcana/mud/toggle-avatar" disable
  assert_success || return 1
...
test_toggle_avatar() {
  ...
  run_sourced_spell "spells/.arcana/mud/toggle-avatar"
  assert_success || return 1
