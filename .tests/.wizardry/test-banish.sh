...
test_help() {
  run_spell "spells/.wizardry/banish" --help
...
test_basic_execution() {
  ...
  WIZARDRY_DIR="$install_dir" run_spell "spells/.wizardry/banish"
  assert_success || return 1
...
test_auto_detect_from_home() {
  ...
  HOME="$tmpdir" run_spell "spells/.wizardry/banish"
  assert_success || return 1
}
...
test_verbose_mode() {
  ...
  WIZARDRY_DIR="$install_dir" run_spell "spells/.wizardry/banish" --verbose
  assert_success || return 1
...
test_custom_wizardry_dir() {
  ...
  WIZARDRY_LOG_LEVEL=1 run_spell "spells/.wizardry/banish" --wizardry-dir "$install_dir"
  assert_success || return 1
...
test_missing_invoke_wizardry() {
  ...
  WIZARDRY_DIR="$tmpdir/.wizardry" run_spell "spells/.wizardry/banish"
...
test_explicit_level_0() {
  ...
  WIZARDRY_DIR="$install_dir" run_spell "spells/.wizardry/banish" 0
  assert_success || return 1
  assert_output_contains "Level 0" || return 1
}
...
test_level_1_requires_menu() {
  ...
  WIZARDRY_DIR="$install_dir" WIZARDRY_LOG_LEVEL=1 run_spell "spells/.wizardry/banish" 1 --no-tests
  assert_success || return 1
...
test_no_tests_flag() {
  ...
  WIZARDRY_DIR="$install_dir" run_spell "spells/.wizardry/banish" --no-tests
  assert_success || return 1
...
test_verbose_shows_level_info() {
  ...
  WIZARDRY_DIR="$install_dir" run_spell "spells/.wizardry/banish" 1 --verbose --no-tests
  assert_success || return 1
...
test_invalid_level() {
  run_spell "spells/.wizardry/banish" 99
  assert_failure || return 1
...
test_banish_shows_detailed_status() {
  ...
  WIZARDRY_DIR="$install_dir" run_spell "spells/.wizardry/banish" 1
  assert_success || return 1
...
test_conditional_set_e_script_mode() {
  ...
  WIZARDRY_DIR="$install_dir" run_spell "spells/.wizardry/banish" 999
  assert_failure || return 1
