...
reset_default_synonyms_help_via_sourcing() {
  _run_sourced_spell reset-default-synonyms --help
...
_run_test_case "reset-default-synonyms works via source-then-invoke" reset_default_synonyms_help_via_sourcing
_finish_tests
