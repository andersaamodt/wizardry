...
edit_synonym_help_via_sourcing() {
  _run_sourced_spell edit-synonym --help
  _assert_success || return 1
...
_run_test_case "edit-synonym works via source-then-invoke" edit_synonym_help_via_sourcing
_finish_tests
