...
copy_rejects_directories_and_missing_target() {
  ...
  assert_failure || return 1
  assert_output_contains "That path is not a file." || return 1

  run_spell "spells/arcane/copy" "$tmpdir/nonexistent-file"
  assert_failure || return 1
  assert_output_contains "That file does not exist." || return 1
}
...
STUB
  ...
  PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/paths:$ROOT_DIR/spells/.imps/fs:$ROOT_DIR/spells/.imps/sys:$stubdir" CLIPBOARD_FILE="$clipboard" run_spell "spells/arcane/copy" "$file"
  assert_success || return 1
...
copy_fails_without_clipboard_tools() {
  ...
  PATH="$ROOT_DIR/spells/cantrips:$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/paths:$ROOT_DIR/spells/.imps/fs:$ROOT_DIR/spells/.imps/sys:$stubdir" run_spell "spells/arcane/copy" "$file"
  assert_failure || return 1
