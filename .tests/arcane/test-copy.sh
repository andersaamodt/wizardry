...
STUB
  ...
  PATH="$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/paths:$ROOT_DIR/spells/.imps/fs:$ROOT_DIR/spells/.imps/sys:$stubdir" CLIPBOARD_FILE="$clipboard" _run_spell "spells/arcane/copy" "$file"
  _assert_success || return 1
...
copy_fails_without_clipboard_tools() {
  ...
  PATH="$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/paths:$ROOT_DIR/spells/.imps/fs:$ROOT_DIR/spells/.imps/sys:$stubdir" _run_spell "spells/arcane/copy" "$file"
  _assert_failure || return 1
