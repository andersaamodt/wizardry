...
STUB
  ...
  PATH="$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/paths:$ROOT_DIR/spells/.imps/fs:$ROOT_DIR/spells/.imps/os:$stubdir" CLIPBOARD_FILE="$clipboard" run_spell "spells/arcane/copy" "$file"
  assert_success || return 1
...
copy_fails_without_clipboard_tools() {
  ...
  PATH="$ROOT_DIR/spells/.imps/cond:$ROOT_DIR/spells/.imps/out:$ROOT_DIR/spells/.imps/paths:$ROOT_DIR/spells/.imps/fs:$ROOT_DIR/spells/.imps/os:$stubdir" run_spell "spells/arcane/copy" "$file"
  assert_failure || return 1
