...
<button hx-get="/cgi/poll-vote?vote=A" hx-target="#poll-results" hx-swap="outerHTML" class="poll-btn">
🔵 Functional Programming
</button>
<button hx-get="/cgi/poll-vote?vote=B" hx-target="#poll-results" hx-swap="outerHTML" class="poll-btn">
🟢 Object-Oriented
</button>
<button hx-get="/cgi/poll-vote?vote=C" hx-target="#poll-results" hx-swap="outerHTML" class="poll-btn">
🟡 Procedural
</button>
</div>

<div id="poll-results" hx-get="/cgi/poll-vote" hx-trigger="load" hx-swap="outerHTML">
Loading results...
</div>
</div>
