...
2. **Canonical spec:** `.github/FULL_SPEC.md` (complete specification - reference frequently) ⭐⭐⭐
3. **Main guide:** `.github/copilot-instructions.md` (templates, rules, workflows)
4. **Core knowledge bases:**
...
5. **Detailed guides:** `.github/instructions/*.md` (topic-specific details)
...
- **Canonical spec:** `.github/FULL_SPEC.md` ⭐⭐⭐ (reference frequently, keep updated)
...
- **Shell patterns:** `.github/SHELL_CODE_PATTERNS.md` ⭐ (document new discoveries)
- **Cross-platform patterns:** `.github/CROSS_PLATFORM_PATTERNS.md` ⭐ (document new discoveries)
- **Lessons learned:** `.github/LESSONS.md` (check when debugging)
