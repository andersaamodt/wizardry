...
```sh
# Send errors to stderr with spell name prefix (not "Error:")
printf '%s\n' "spell-name: something went wrong." >&2

# Error messages must be declarative, not imperative
# WRONG: "Please install X" or "Run Y to fix"
# CORRECT: "spell-name: X not found." or "spell-name: Y required."
```
