...
**Canonical Specification:** See `.github/FULL_SPEC.md` for complete atomic specification. Reference frequently and keep updated.

## Quick Start

**Core Documentation** (keep content non-redundant):
1. **FULL_SPEC.md** — Canonical specification ⭐⭐⭐
2. **SHELL_CODE_PATTERNS.md** — POSIX patterns/best practices ⭐
3. **CROSS_PLATFORM_PATTERNS.md** — Cross-platform compatibility ⭐
4. **EXEMPTIONS.md** — Documented exceptions
5. **LESSONS.md** — Debugging insights

**Start here:**
1. **README.md** — Project philosophy (read first)
2. **FULL_SPEC.md** — Complete spec (reference frequently)
3. **copilot-instructions.md** — Templates, rules, workflows
4. **Topic guides** — See `.github/` for spells.md, imps.md, tests.md, logging.md, etc.
...
**Core Documentation** (keep content non-redundant):
1. **FULL_SPEC.md** ⭐⭐⭐ — Canonical spec (reference frequently, keep updated)
2. **SHELL_CODE_PATTERNS.md** ⭐ — POSIX patterns (document new discoveries)
3. **CROSS_PLATFORM_PATTERNS.md** ⭐ — Cross-platform (document new discoveries)
4. **EXEMPTIONS.md** — Documented exceptions
5. **LESSONS.md** — Debugging insights (check when debugging)

**Quick Access:**
- **README.md** — Philosophy
- **copilot-instructions.md** — Main guide
- **Topic guides** (all in `.github/`):
  - `spells.md` — Spell writing
  - `imps.md` — Imps
  - `tests.md` — Testing
  - `logging.md` — Output/logging
  - `glossary-and-function-architecture.md` — Glossary
