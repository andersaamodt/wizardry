...
0. **README.md** — **MOST CANONICAL** — Philosophy, values, standards ⭐⭐⭐
1. **FULL_SPEC.md** — Technical specification ⭐⭐⭐
...
2. **FULL_SPEC.md** — Complete technical spec (reference frequently)
...
**Core Documentation** (keep content non-redundant):
0. **README.md** ⭐⭐⭐ — **MOST CANONICAL** — Philosophy, values, standards
1. **FULL_SPEC.md** ⭐⭐⭐ — Technical spec (reference frequently, keep updated)
