...
- Filesystem directory mtime has 1-second granularity; use directory entry count instead of mtime comparison to detect sub-second changes (e.g., users joining chatroom).
