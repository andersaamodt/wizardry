...
- All source-only spells must use the standard inline uncastable pattern (see AI documentation); the `uncastable` imp has been deprecated for transparency and standardization.
