...
- Spells must call `require_wizardry()` and `env_clear()` (underscored functions, not hyphenated commands) inside their main function; castable sources the imps to make functions available.
