...
- **Topic guides** (all in `.github/`):
  ...
  - `logging.md` — Output/error handling
  - `glossary-and-function-architecture.md` — Glossary system
  - `spells/.imps/sys/spell-levels` — Spell level definitions (code)
