...
STUB
  ...
  REQUIRE_LOG="$require_log" REQUIRE_COMMAND="$stub_dir/require-command" run_spell "spells/update-wizardry"
...
STUB
  ...
  PATH="$stub_dir:$PATH" REQUIRE_COMMAND="$stub_dir/require-command" GIT_LOG="$git_log" WIZARDRY_DIR="$wizard_dir" \
    run_spell "spells/update-wizardry"
  assert_success
...
STUB
  ...
  PATH="$stub_dir:$PATH" REQUIRE_COMMAND="$stub_dir/require-command" run_spell "spells/update-wizardry"
  assert_failure
