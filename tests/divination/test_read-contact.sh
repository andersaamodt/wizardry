...
test_help() {
  run_spell "spells/divination/read-contact" --help
...
read_contact_requires_path() {
  run_spell "spells/divination/read-contact"
...
CARD
  ...
  run_spell "spells/divination/read-contact" "$card"
  assert_success || return 1
...
CARD
  ...
  run_spell "spells/divination/read-contact" "$card" TEL
  assert_success || return 1
...
read_contact_rejects_missing_file() {
  ...
  run_spell "spells/divination/read-contact" "$missing_path"
  assert_failure || return 1
...
read_contact_rejects_malformed_cards() {
  ...
  run_spell "spells/divination/read-contact" "$empty_card"
  assert_failure || return 1
...
CARD
  ...
  run_spell "spells/divination/read-contact" "$broken_card"
  assert_failure || return 1
...
CARDS
  ...
  run_spell "spells/divination/read-contact" "$card_path"
  assert_failure || return 1
