...
test_pkg_update_runs() {
  ...
  _run_spell spells/.imps/pkg/pkg-update
...
_run_test_case "pkg-update runs" test_pkg_update_runs
_run_test_case "pkg-update detects manager" test_pkg_update_detects_manager
